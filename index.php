...
doc: |
  ...
  Attention, je n'utilise que le domaine 0 du scheme.
journal: |
  22/7/2021:
    première version
*/
...
class YamlSkos { // classe statique permettant de créer la structure à partir du contenu du fichier YamlSkos et de l'afficher
  ...
  // liste de certains domaines d'intérêt qui peuvent être sélectionnés
  ...
  static public array $titles; // Titre du thésaurus multi-langue
...
class Domain { // 1er niveau de la structuration
